...
const menuItems = [
  ...
  { icon: Rocket, label: "Create Tasks", path: "/create-tasks" },
  { icon: ClipboardList, label: "Task Queue", path: "/tasks" },
  { icon: ScrollText, label: "Logs", path: "/logs" },
  { icon: Settings, label: "Schedule", path: "/schedule" },
];
        ...
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-sm text-muted-foreground text-center max-w-sm">
              Sign in to manage your Google review automation tasks and accounts.
            </p>
          </div>
          <Button
            onClick={() => {
